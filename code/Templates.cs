namespace MyProject.Foundation.Assets
{
    using Sitecore.Data;
    ...
    public struct Templates
    {
        ...
        {
            public static readonly ID ID = new ID("{52207FDF-292B-4B54-8FA1-A0191121EDFA}");

            public struct Fields
            {
                public static readonly ID SiteScriptFiles = new ID("{8C655B2E-BB70-43D0-9E53-6B52BE87779A}");
                public static readonly ID SiteStylingFiles = new ID("{EB71E636-E3A3-4665-BE77-146750B92B5B}");                
            }
        }
